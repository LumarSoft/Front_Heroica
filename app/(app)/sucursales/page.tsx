              ...
              >
                ...
                <div className="absolute top-4 right-4 flex items-center gap-1.5 opacity-0 group-hover:opacity-100 z-10">
                  <button
                    onClick={e => {
                      e.stopPropagation()
                      window.open(`/sucursales/${sucursal.id}`, '_blank')
                    }}
                    className="w-9 h-9 rounded-lg bg-white border border-[#D8E3F8] text-[#002868] hover:bg-[#002868] hover:text-white hover:border-[#002868] transition-all flex items-center justify-center shadow-sm hover:shadow-md cursor-pointer"
                  ...
                  {canGestionarSucursales && (
                    <button
                      ...
                      className="w-9 h-9 rounded-lg bg-white border border-red-200 text-red-600 hover:bg-red-600 hover:text-white hover:border-red-600 transition-all flex items-center justify-center shadow-sm hover:shadow-md cursor-pointer"
